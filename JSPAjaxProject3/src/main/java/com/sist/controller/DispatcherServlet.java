...
/*
 	...
 	model 2 (JSP/Java) => 단점: 복합성, 장점: 여러명이 동시에 개발, 추가, 확장성, 재사용 용이 (유지보수 굿)
 	                   => Controller에 집중이 된다
 	
 	domain : Controller를 나눠서 작업(분산처리) => Spring 5
 	         기능별 서버를 나눠서 독립적으로 개발
 	         MSA  => Spring - Cloud
 	         ------------------------- CI/CD (git 기반, 도커, 쿠바네티스, 젠킨스)
 	*.do => 어떤 단어가 들어와도 된다 => Controller 소환
 	*
