...
let u=0;
$(function(){ // jquery의 시작 : $(document).ready(function(){})
    ...
    <div class="row">
      <table class="table">
        ...
        <tr>
          ...
          <td colspan="3">
           <a href="download.jsp?fno=<%=vo.getFilename() %>"><%=vo.getFilename() %>(<%=vo.getFilesize() %>Bytes)</a>
          </td>
        </tr>
        <%
        	}
        ...
        <table class="table">
            <tr>
               <td>
			     ...
			     <textarea rows="4" cols="50" name="msg" style="float:left"></textarea>
			     <input type="hidden" name="bno" value="<%=vo.getNo() %>">
			     <input type=submit value="댓글쓰기" class="btn btn-sm btn-danger"
			        style="width:100px;height:90px"
			     >
