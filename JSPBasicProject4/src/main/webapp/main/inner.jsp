...
<body>
  ...
  <table class="table">
    <tr>
      <td colspan="2">
       내장 객체: 미리 객체를 생성해서 필요시마다 사용이 가능하게 만들어준다<br>
               => 모든 서버에서 request,response,session 등 지원<br>
    ...
    <tr>
      <td colspan="2">
        <pre>public void _jspService(<mark>HttpServletRequest request,
         http.HttpServletResponse response</mark>)
        {
    ...
    <tr>
      ...
      <td width=75%>서버에 사용자의 일부 정보를 저장 후: 전역변수처럼 사용함.</td>
    </tr>
    <tr>
      <td width=25%>pageContext</td>
      <td width=75%>페이지의 흐름(request)관리:JSP 여러개를 조립</td>
    </tr>
    <tr>
      <td width=25%>config,exception,page</td>
      <td width=75%>외부환경 설정,예외 관리</td>
    </tr>
  </table>
</body>
</html>
