      ...
      <div id="gallery">
        <figure>
          <header class="heading">
           <form method=post action="../food/location_find.do" class="incline" id="locFrm">
          ...
          <ul class="nospace clear">
           <c:forEach var="vo" items="${list }" varStatus="s">
            <li class="one_quarter ${s.index%4==0?'first':'' }"><a href="../food/food_detail_before.do?fno=${vo.fno }"><img src="${vo.poster }" title="${vo.name }"></a></li>
           </c:forEach>
          </ul>
