...
$(function(){
	...
	$('#logBtn').click(function(){
		...
		// 전송 => 실행 결과를 가지고 온다 (자체 처리) (요청=응답: Ajax,Vue,React)
		$.ajax({
			type:'post',
			url:'../member/login.do',
			data:{"id":id,"pwd":pwd},
    ...
    <div class="fl_right">
     ...
     <c:if test="${sessionScope.id!=null }">
      <ul class="inline">
        ...
        <li>${sessionScope.name }(${sessionScope.admin=='y'?"관리자":"일반사용자" })님 로그인 중입니다</li>
