...
<div class="wrapper row3">
  <main class="container clear"> 
    ...
    <!-- ################################################################################################ -->
    <h2 class="sectiontitle">믿고 보는 맛집</h2>
    <!-- ################################################################################################ -->
    ...
    <div class="flexslider carousel basiccarousel btmspace-80">
      <ul class="slides">
        <c:forEach var="vo" items="${cList}" varStatus="s">
         <c:if test="${s.index>=0 && s.index<12 }">
          <li>
           <figure><a href="../food/food_category_detail.do?fno=${vo.fno }"><img class="radius-10 btmspace-10" src="${vo.poster }" alt=""></a>
            <figcaption><a href="../food/food_category_detail.do?fno=${vo.fno }">${vo.name }</a></figcaption>
           </figure>
          </li>
         </c:if>
        </c:forEach>
