...
<script type="text/javascript" src="//dapi.kakao.com/v2/maps/sdk.js?appkey=6a1ffbe66e5a8ba9af15d82e0b41ceac&libraries=services"></script>
<style type="text/css">
.container{
	margin-top:50px;
}
    ...
    <div class="row">
      ...
      <div class="col-sm-7">
        <table class="table">
          <tr>
            <td colspan="2">
             <h3>${vo.name }&nbsp;<span style="color:orance">${vo.score }</span></h3>
            </td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td width=80%>
              <ul>
                <c:forTokens var='won' items="${vo.getMenu() }" delims="원">
						<li>${won }원</li>						
					</c:forTokens>
              </ul>
            </td>
